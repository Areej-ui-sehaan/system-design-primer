...
Talking points: relationship symmetry (store on both users?), request state machine, Chat abstraction covers 1:1 vs N:N, scaling notes (message feed fanout, presence via heartbeats — link system-design async/queues).
